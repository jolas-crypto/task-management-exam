...
-- Dumping structure for table task_management.comments
...
CREATE TABLE IF NOT EXISTS `tasks` (
  ...
  `assigned_to` smallint DEFAULT '0',
  `assigned_to_created_by` smallint DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `tasks_user_id_foreign` (`user_id`),
  KEY `tasks_assigned_to_index` (`assigned_to`),
  KEY `tasks_assigned_to_created_by_index` (`assigned_to_created_by`),
